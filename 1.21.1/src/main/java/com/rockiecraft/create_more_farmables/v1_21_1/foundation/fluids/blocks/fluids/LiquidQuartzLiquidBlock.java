...
public class LiquidQuartzLiquidBlock extends AbstractMoltenLiquidBlock {

    public LiquidQuartzLiquidBlock(Supplier<? extends FlowingFluid> fluid, Properties properties) {
        super(fluid, properties, AllDamageSources.LIQUID_QUARTZ);
    }
    ...
    protected String getConversionBlockId() {
        return CreateMoreFarmablesConfig.CreateMoreFarmables_fluid_interactions.LiquidQuartzConversionBlock;
    }
