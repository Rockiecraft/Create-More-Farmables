...
public class DyeSplashingFanProcessingType implements FanProcessingType {
    ...
    // CreateBuiltInRegistries.FAN_PROCESSING_TYPE registry instead (FanProcessingTypeRegistry's
    // sorted list is now populated FROM that registry by Create itself, on freeze).
