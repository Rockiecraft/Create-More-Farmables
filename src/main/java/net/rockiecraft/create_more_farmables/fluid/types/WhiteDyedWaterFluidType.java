...
public class WhiteDyedWaterFluidType extends FluidType {
    public WhiteDyedWaterFluidType() {
        super(FluidType.Properties.create().fallDistanceModifier(0F).canExtinguish(true).supportsBoating(true).canHydrate(true).canPushEntity(true).pathType(BlockPathTypes.WATER).motionScale(0.007D).canConvertToSource(true)
