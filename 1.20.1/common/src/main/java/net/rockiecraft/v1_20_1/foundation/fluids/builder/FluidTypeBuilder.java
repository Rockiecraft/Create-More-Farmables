...
public class FluidTypeBuilder {
    ...
    // NOTE: 1.20.1 dropped Item.Properties#tab(CreativeModeTab) - no .tab(...) call needed here.
    // CreativeModeTabs.MAIN_TAB pulls every bucket in automatically via AllItems.BASIC_ITEMS.
