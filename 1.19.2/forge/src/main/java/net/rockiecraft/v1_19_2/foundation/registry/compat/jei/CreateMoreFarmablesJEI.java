	...
	public void registerCategories(IRecipeCategoryRegistration registration) {
		...
		Supplier<List<DyeSplashingRecipe>> recipesSupplier = () -> {
			...
			if (minecraft.getConnection() != null)
				recipes.addAll(minecraft.getConnection()
					.getRecipeManager()
					.getAllRecipesFor(DyeSplashingRecipeType.DYE_SPLASHING.getType()));
			return recipes;
		};
		...
		Supplier<List<MoltenBlastingRecipe>> moltenRecipesSupplier = () -> {
			...
			if (minecraft.getConnection() != null)
				recipes.addAll(minecraft.getConnection()
					.getRecipeManager()
					.getAllRecipesFor(MoltenBlastingRecipeType.MOLTEN_BLASTING.getType()));
			return recipes;
		};
