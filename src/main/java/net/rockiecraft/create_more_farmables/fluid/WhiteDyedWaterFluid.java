...
public abstract class WhiteDyedWaterFluid extends ForgeFlowingFluid{

    public static final ForgeFlowingFluid.Properties PROPERTIES = new ForgeFlowingFluid.Properties(AllFluidTypes.WHITE_DYED_WATER_TYPE, AllFluids.WHITE_DYED_WATER,
    ...
    private WhiteDyedWaterFluid() {
        super(PROPERTIES);
    }

    public static class Source extends WhiteDyedWaterFluid {
