...
public class MoltenBlastingRecipeType implements IRecipeTypeInfo {
    ...
    public static final ResourcefulRegistry<RecipeSerializer<?>> SERIALIZERS =
            ResourcefulRegistries.create(BuiltInRegistries.RECIPE_SERIALIZER, CreateMoreFarmables.MOD_ID);
    public static final ResourcefulRegistry<RecipeType<?>> TYPES =
            ResourcefulRegistries.create(BuiltInRegistries.RECIPE_TYPE, CreateMoreFarmables.MOD_ID);
    ...
    private final RegistryEntry<RecipeType<?>> type =
            TYPES.register("molten_blasting", () -> simpleType(id));

    /** See DyeSplashingRecipeType#simpleType for why this workaround exists on Fabric. */
