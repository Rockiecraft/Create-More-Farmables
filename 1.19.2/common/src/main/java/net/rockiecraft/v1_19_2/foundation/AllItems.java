...
public class AllItems {
    ...
    public static final CreativeModeTab MAIN_TAB = CreativeTabRegistry.create(new ResourceLocation(CreateMoreFarmables.MOD_ID, "main_tab"), () -> new ItemStack(AllItems.SHULKER_SHELL_FRAGMENT.get()));
    public static final ResourcefulRegistry<Item> BASIC_ITEMS = ResourcefulRegistries.create(Registry.ITEM, CreateMoreFarmables.MOD_ID);
    ...
    // Fluid bucket items are registered here too, but declared in AllFluids.java - see FluidTypeBuilder.
