...
public final class AllDamageSources {
    ...
    public static final ResourceKey<DamageType> FAN_MOLTEN = ResourceKey.create(Registries.DAMAGE_TYPE, new ResourceLocation(CreateMoreFarmables.MOD_ID, "fan_molten"));
