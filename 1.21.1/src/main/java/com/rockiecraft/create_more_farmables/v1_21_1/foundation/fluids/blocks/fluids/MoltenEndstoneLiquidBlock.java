...
public class MoltenEndstoneLiquidBlock extends AbstractMoltenLiquidBlock {

    public MoltenEndstoneLiquidBlock(Supplier<? extends FlowingFluid> fluid, Properties properties) {
        super(fluid, properties, AllDamageSources.MOLTEN_ENDSTONE);
    }
    ...
    protected boolean isInteractionEnabled() {
        return CreateMoreFarmablesConfig.CreateMoreFarmables_fluid_interactions.ToggleAllInteractions
            && CreateMoreFarmablesConfig.CreateMoreFarmables_fluid_interactions.MoltenEndstoneInteraction;
    }

    @Override
    protected String getConversionBlockId() {
        return CreateMoreFarmablesConfig.CreateMoreFarmables_fluid_interactions.MoltenEndstoneConversionBlock;
    }
